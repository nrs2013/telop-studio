...
export default function ProjectPage() {
  ...
  // ====== 譜割（SCORE）タブ ======
  // ★ DATA_SAFETY_RULES に従い、ロード時のデータ加工は一切しない（そのまま読む）
  // ★ ペースト自動振り分け等、勝手にデータを動かす処理は禁止
